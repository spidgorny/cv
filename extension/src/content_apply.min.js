...
module.exports={
	"basics": {
		...
		"password": "password",
		"preferredContact": ["E-mail", "e-mail"],
		"location": {
...
},{"./../fixture/thomasdavis.json":1,"./FieldConfig":3,"./JSONResume":4,"./sites/BMWGroupDe":6,"./sites/IndeedCom":8,"./sites/OnApplyDe":9}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
class FieldConfig {
    constructor(props) {
