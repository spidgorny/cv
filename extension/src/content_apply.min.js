...
module.exports={
	"basics": {
		...
		"nationality": ["Germany", "Russia", "New Zealand"],
...
},{"./../fixture/thomasdavis.json":1,"./DocumentFields":3,"./JSONResume":5,"./sites/BMWGroupDe":7,"./sites/DaimlerCom":9,"./sites/IndeedCom":10,"./sites/JobsNintendoDe":11,"./sites/OnApplyDe":12,"./sites/TaleoNet":13}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./FieldConfig":4}],4:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
class FieldConfig {
    constructor(props) {
...
},{"./BasicFiller":8}],13:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const BasicFiller_1 = require("./BasicFiller");
/**
...
class TaleoNet extends BasicFiller_1.BasicFiller {
    constructor(resume) {
        ...
        this.map = {
            ...
            'input[name="jobTitle_2"]': 'work.0.position',
